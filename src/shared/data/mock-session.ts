...
function createMockSystemMarkers(): SystemMarker[] {
    return [
        ...
        {
            time: 65,
            label: 'Observation formateur',
            description: "Hésitation sur le choix de la verrerie",
            category: 'manual'
        },
...
function createMockIncidentMarkers(): IncidentMarker[] {
    return [
        {
            time: 12,
            label: 'Erreur EPI: lunettes manquantes',
            severity: 'moderate',
            description: 'Manipulation commencée sans protection oculaire'
        },
        {
            time: 58,
            label: 'Mauvaise verrerie pour acide concentré',
            severity: 'moderate',
            description: 'Utilisation d\'un bécher au lieu d\'une fiole jaugée'
        },
        {
            time: 63,
            label: 'Projection acide sur paillasse',
            severity: 'critical',
            description: 'Éclaboussure lors du mélange, risque de contamination'
        },
        {
            time: 108,
            label: 'Résidus non neutralisés dans évier',
            severity: 'critical',
            description: 'Rejet direct sans neutralisation préalable'
        },
    ];
}

export function createMockRecordData(duration: number): RecordData {
    return {
        duration: duration,
