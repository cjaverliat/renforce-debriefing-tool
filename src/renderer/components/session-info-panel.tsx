...
export function SessionInfoPanel({
    ...
    return (
        <div className="flex flex-col h-full bg-zinc-900 border-r border-zinc-800 overflow-y-auto custom-scrollbar">
            <Accordion
                type="multiple"
                defaultValue={['physio', 'procedures', 'markers']}
                className="p-2"
            >
                {/* Physio Tracks */}
                <AccordionItem value="physio" className="border-zinc-800">
                    <AccordionTrigger className="hover:no-underline px-2 py-3">
                        <div className="flex items-center gap-2 flex-1">
                            <Activity className="size-4 text-emerald-500 shrink-0"/>
                            <span className="text-sm text-zinc-100">Physio Tracks</span>
                ...
                {/* Procedures */}
                <AccordionItem value="procedures" className="border-zinc-800">
                    <AccordionTrigger className="hover:no-underline px-2 py-3">
                        <div className="flex items-center gap-2 flex-1">
                ...
                {/* System Markers */}
                <AccordionItem value="markers" className="border-zinc-800">
                    <AccordionTrigger className="hover:no-underline px-2 py-3">
                        <div className="flex items-center gap-2 flex-1">
